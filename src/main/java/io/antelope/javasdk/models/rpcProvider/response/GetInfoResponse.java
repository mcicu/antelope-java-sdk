...
public class GetInfoResponse {
     ...
     * call:  {@link io.antelope.javasdk.utilities.EOSFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     */
     ...
     * io.antelope.javasdk.interfaces.IRPCProvider#getBlock(GetBlockRequest)} at {@link
     * io.antelope.javasdk.session.TransactionProcessor#prepare(List)}
     */
     ...
     * Transaction#setExpiration(String)}} at {@link io.antelope.javasdk.session.TransactionProcessor#prepare(List)}
     */
     ...
     * io.antelope.javasdk.utilities.EOSFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     *
     * @return the chain id.
     */
     ...
     * io.antelope.javasdk.interfaces.IRPCProvider#getBlockInfo(GetBlockInfoRequest)} at {@link
     * io.antelope.javasdk.session.TransactionProcessor#prepare(List)}
